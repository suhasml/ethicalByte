...
>(
  ...
  new (
    ...
    setState<K extends never>(
      state:
        ...
        | ((
            prevState: Readonly<{}>,
            props: Readonly<Props<S, A, MonitorState, MonitorAction>>
          ) => {} | Pick<{}, K> | null)
        | Pick<{}, K>
        | null,
    ...
    readonly props: Readonly<Props<S, A, MonitorState, MonitorAction>> &
      Readonly<{
    ...
    shouldComponentUpdate?(
      nextProps: Readonly<Props<S, A, MonitorState, MonitorAction>>,
      nextState: Readonly<{}>,
      nextContext: any
    ): boolean;
    ...
    getSnapshotBeforeUpdate?(
      prevProps: Readonly<Props<S, A, MonitorState, MonitorAction>>,
      prevState: Readonly<{}>
    ): any;
    componentDidUpdate?(
      prevProps: Readonly<Props<S, A, MonitorState, MonitorAction>>,
  ...
  instrument: (
    options?: Options<S, A, MonitorState, MonitorAction> | undefined
  ) => import("redux").StoreEnhancer<
    import("redux-devtools-instrument").InstrumentExt<any, any, MonitorState>,
    {}
  >;
