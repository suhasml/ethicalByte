...
var ActionCreators = {
  performAction: function performAction(
    action,
    trace,
    traceLimit, // eslint-disable-next-line @typescript-eslint/ban-types
    toExcludeFromTrace
  ) {
...
function liftReducerWith(
  ...
  return function (liftedState, liftedAction) {
    ...
    function commitExcessActions(n) {
      ...
      stagedActionIds = [0].concat(
        _toConsumableArray(stagedActionIds.slice(excess + 1))
      );
    ...
    function computePausedAction(shouldInit) {
      ...
      if (shouldInit) {
        ...
        stagedActionIds = [].concat(_toConsumableArray(stagedActionIds), [
          nextActionId,
        ]);
        nextActionId++;
      }
      ...
      return {
        monitorState: monitorState,
        actionsById: _objectSpread(
          _objectSpread({}, actionsById),
          {},
          _defineProperty(
            {},
            nextActionId - 1,
    ...
    if (/^@@redux\/(INIT|REPLACE)/.test(liftedAction.type)) {
      ...
      switch (liftedAction.type) {
        ...
        case ActionTypes.TOGGLE_ACTION: {
          ...
          if (index === -1) {
            skippedActionIds = [_actionId3].concat(
              _toConsumableArray(skippedActionIds)
            );
          } else {
            skippedActionIds = skippedActionIds.filter(function (id) {
        ...
        case ActionTypes.SET_ACTIONS_ACTIVE: {
          ...
          if (active) {
            skippedActionIds = (0, _difference["default"])(
              skippedActionIds,
              actionIds
            );
          } else {
            skippedActionIds = (0, _union["default"])(
              skippedActionIds,
              actionIds
            );
          } // Optimization: we know history before this action hasn't changed
        ...
        case ActionTypes.SWEEP: {
          ...
          stagedActionIds = (0, _difference["default"])(
            stagedActionIds,
            skippedActionIds
          );
          skippedActionIds = [];
        ...
        case ActionTypes.REORDER_ACTION: {
          ...
          if (diff > 0) {
            // move left
            stagedActionIds = [].concat(
              _toConsumableArray(stagedActionIds.slice(0, newIdx)),
              [_actionId4],
              _toConsumableArray(stagedActionIds.slice(newIdx, idx)),
              _toConsumableArray(stagedActionIds.slice(idx + 1))
            );
            minInvalidatedStateIndex = newIdx;
          } else if (diff < 0) {
            // move right
            stagedActionIds = [].concat(
              _toConsumableArray(stagedActionIds.slice(0, idx)),
              _toConsumableArray(stagedActionIds.slice(idx + 1, newIdx)),
              [_actionId4],
              _toConsumableArray(stagedActionIds.slice(newIdx))
            );
...
function unliftStore(liftedStore, liftReducer, options) {
  ...
  return _objectSpread(
    ...
    _defineProperty(
      ...
      _symbolObservable["default"],
      function () {
        return _objectSpread(
          _objectSpread({}, liftedStore[_symbolObservable["default"]]()),
          {},
          _defineProperty(
            {
