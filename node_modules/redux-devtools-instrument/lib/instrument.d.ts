...
export declare type LiftedAction<S, A extends Action<unknown>, MonitorState> =
  | PerformAction<A>
  | ResetAction
  | RollbackAction
  | CommitAction
...
export declare const ActionCreators: {
  performAction<A extends Action<unknown>>(
    action: A,
    trace?: boolean | ((action: A) => string | undefined) | undefined,
  ...
  importState<S, A_1 extends Action<unknown>, MonitorState = null>(
    nextLiftedState: LiftedState<S, A_1, MonitorState> | readonly A_1[],
    noRecompute?: boolean | undefined
  ): ImportStateAction<S, A_1, MonitorState>;
 ...
 */
export declare function liftAction<A extends Action<unknown>>(
  action: A,
 ...
 */
export declare function liftReducerWith<
  S,
 ...
 */
export declare function unliftState<
  S,
  A extends Action<unknown>,
  MonitorState,
  NextStateExt
...
export declare type LiftedReducer<S, A extends Action<unknown>, MonitorState> =
  Reducer<LiftedState<S, A, MonitorState>, LiftedAction<S, A, MonitorState>>;
export declare type LiftedStore<S, A extends Action<unknown>, MonitorState> =
  Store<LiftedState<S, A, MonitorState>, LiftedAction<S, A, MonitorState>>;
export declare type InstrumentExt<S, A extends Action<unknown>, MonitorState> =
  {
    liftedStore: LiftedStore<S, A, MonitorState>;
  };
export declare type EnhancedStore<S, A extends Action<unknown>, MonitorState> =
  Store<S, A> & InstrumentExt<S, A, MonitorState>;
/**
 * Provides an app's view into the lifted store.
 */
export declare function unliftStore<
  S,
  A extends Action<unknown>,
  MonitorState,
  MonitorAction extends Action<unknown>,
